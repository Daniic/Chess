...
public class Celda extends JButton implements Serializable {
	...
	public static java.awt.Color colorBordeCeldaNormal = new java.awt.Color(MyConfig.getInstancia().getBorderNormalCell());
	...
	public void setPieza(Pieza pieza) {
		...
		if (pieza != null) {
			...
			ImageIcon imageIconResized = new ImageIcon(getScaledImage(image,35));
